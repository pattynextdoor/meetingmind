...
If you don't want to maintain a regex, [MeetingMind](/) handles Zoom VTT parsing natively — drop the file in a watched folder and it produces the same shape of note automatically, plus auto-links participants to existing notes in your vault. Free tier handles import; [Pro tier](https://tumbucon.gumroad.com/l/meetingmind-pro) ($39 lifetime) adds AI summaries and action item extraction. Disclosure: I built it.
